...
import { ICON, rows, selected, STEPS, TITLES, VIEWS, wizardChoices } from './tui-state.mjs';
...
function footerKeys(job) {
  ...
  return [basic, finished, retry, resume, 'R redraw · ? help · q quit'].filter(Boolean).join('  │  ');
}
