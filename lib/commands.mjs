...
export const ENGINES = ['claude', 'codex', 'opencode'];

/** Every case in the dispatch of kaip.mjs, aliases included (ls, project). */
export const COMMANDS = [
  'add', 'list', 'ls', 'show', 'run', 'rm', 'retry', 'clear', 'out', 'chat', 'edit', 'usage', 'quota',
  'projects', 'project', 'sessions', 'daemon', 'app', 'serve', 'mobile', 'engines', 'migrate', 'gui', 'help',
];
