...
import { chatDTO, outputDTO, stateDTO, targetsDTO } from './server-dto.mjs';
...
export { chatDTO, outputDTO, stateDTO, targetsDTO } from './server-dto.mjs';
  ...
  const server = http.createServer((req, res) => {
    ...
    try {
      ...
      if (seg[1] === 'device' && seg[2] && seg.length === 3 && req.method === 'DELETE') {
        ...
        return json(res, { ok: true, removed, devices: c2.devices.length }, 200, enc);
      }
