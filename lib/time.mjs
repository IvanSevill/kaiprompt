...
/**
 * "hace 12 min" — how long ago, rounded to the unit a person would say it in.
 *
 * Deliberately coarser than humanDur: "hace 12m 30s" is a stopwatch reading, and nobody
